...
<jsp:body>
  <div>
    <div class ="container min-container">
      <h2 class="basic-title">List pedidos</h2>
        <div class="well">
          <table class="table table-condensed table-bordered table-striped table-hover">
                  ...
                  <c:forEach items='${paginatedList.currentList}' var='object'>         		
	                  <tr>
						<td><a href="<c:url value='/pedidos'/>/${object.idPedido}">${object.idPedido}</a></td>
		                  	<td>${object.nomeMusica}</td>
	                    <td><a href="<c:url value='/pedidos/remove'/>/${object.idPedido}">Remove</a></td>
					  </tr>
                  </c:forEach>
                  </tbody>
          </table>
